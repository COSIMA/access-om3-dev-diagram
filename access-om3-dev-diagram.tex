...
%    \node [no_border, right = of             CICE6-WW3-f, xshift = \xshift]             (CICE6-WW3-g) {?};
    ...
    \draw [decorate,decoration= {brace,amplitude=0.6cm, raise=0.1cm}, ultra thick] (ACCESS-CM3-1deg.north east) -- (ACCESS-ESM3-1deg.south east) node [midway,xshift=1.8cm] (ACCESS-OM3) {for CMIP7};
