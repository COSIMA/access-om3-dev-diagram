...
\begin{tikzpicture}[node distance = \vertdist,font=\large\sffamily]
    ...
    \node [block, below = of MOM6-CICE6.west, xshift=-2cm, yshift=-1cm] (UPSTREAM) {Upstream code: MOM6, CICE6, WW3, CMEPS, CDEPS, \ldots};
    \node [block, below = of UPSTREAM.east, xshift=2cm, yshift=-1cm] (MOM6-CICE6-WW3) {MOM6-CICE6-WW3};
    ...
    \node [no_border, right = of                       UPSTREAM  , xshift = \xshift]                         (UPSTREAM-a) {\knot};
    ...
    \node [no_border, right = of                       UPSTREAM-a, xshift = \xshift]                       (UPSTREAM-b) {\knot};
    ...
    \node [no_border, right = of                       UPSTREAM-b, xshift = \xshift]                       (UPSTREAM-c) {\knot};
    ...
    \node [no_border, right = of                       UPSTREAM-c, xshift = \xshift]                       (UPSTREAM-d) {\knot};
    ...
    \node [no_border, right = of                       UPSTREAM-d, xshift = \xshift]                        (UPSTREAM-e) {\knot};
    ...
    \node [no_border, right = of                       UPSTREAM-e, xshift = \xshift]                       (UPSTREAM-f) {\knot};
...
%    \node [no_border, right = of          ACCESS-CM3-f, xshift = \xshift]           (ACCESS-CM3-g) {\textbf{ACCESS-CM3}};
    ...
    \node [no_border, right = of                       UPSTREAM-f, xshift = \xshift]                       (UPSTREAM-g) {\knot};
...
%    \node [no_border, below = of ACCESS-CM3-025deg] (ACCESS-CM3-01deg) {0.1$^\circ$};
    ...
    \draw [decorate,decoration= {brace,amplitude=0.6cm, raise=0.1cm}, ultra thick] (MOM6-CICE6-1deg.north east) -- (MOM6-CICE6-WW3-004deg.south east) node [midway,xshift=2.8cm] (ACCESS-OM3) {\textbf{ACCESS-OM3 suite}};
...
%    \draw [-{Latex[length=5mm]}, ultra thick] (MOM6-CICE6-c) to [out=0, in=90] (MOM6-CICE6-WW3-d);
    ...
    % red arrows
    \draw [-{Latex[length=5mm]}, red!90!black, line width=1.5mm] (UPSTREAM) to (UPSTREAM-f);
    \draw [-{Latex[length=5mm]}, red!90!black, ultra thick] (UPSTREAM.east) to [out=0, in=-90] (MOM6-CICE6.south);
    \draw [-{Latex[length=5mm]}, red!90!black, ultra thick] (UPSTREAM.east) to [out=0, in=90] (MOM6-CICE6-WW3.north);
    \draw [-{Latex[length=5mm]}, red!90!black, ultra thick] (UPSTREAM-c) to [out=0, in=-90] (MOM6-CICE6-b);
    \draw [-{Latex[length=5mm]}, red!90!black, ultra thick] (UPSTREAM-c) to [out=0, in=90] (MOM6-CICE6-WW3-b);
    \draw [-{Latex[length=5mm]}, red!90!black, ultra thick] (UPSTREAM-e) to [out=0, in=-90] (MOM6-CICE6-d);
    \draw [-{Latex[length=5mm]}, red!90!black, ultra thick] (UPSTREAM-e) to [out=0, in=90] (MOM6-CICE6-WW3-d);
